...
const PlanDetails = (props) => {
  ...
  return (
    <Grid container item className={planDetails.pageContainer} xs={8}>
      ...
      >
        <Typography id={'plan-details-header'} className={planDetails.header}>
          Your Plan Details
        </Typography>
      </Grid>
      ...
      <Grid container item className={planDetails.contentContainer}>
        <Grid container item className={planDetails.cardContainer}>
          ...
          <Grid item xs={8}>
            ...
            <Typography>
              Free to use with no monthly fees or volume restrictions when you
              use Shippo's carrier accounts.
            </Typography>
            <Typography>
              $0.05 fee will be applied per label when using your own carrier
              account(s).
            </Typography>
          </Grid>
          <Grid item xs={2}>
            <Button
              variant="contained"
              color="success"
              className={planDetails.upgradeButton}
            >
              Upgrade Plan
            </Button>
          </Grid>
      ...
      <Grid container item className={planDetails.contentContainer}>
        <Grid container item className={planDetails.cardContainer}>
          <Grid item xs={8}>
            ...
            <Typography>
              When you close your account, you lose access to your historical
              shopping data and settings.
            </Typography>
          </Grid>
          <Grid container item xs={4}>
            ...
            <Grid item xs={6}>
              {loadingDeleteSubscription ? (
                <Grid item xs={6}>
                  <CircularProgress
                    className={planDetails.closeAccountLoader}
                    color="secondary"
                  />
                </Grid>
              ) : (
                <Grid item xs={6}>
                  <Button
                    className={planDetails.closeAccountLink}
