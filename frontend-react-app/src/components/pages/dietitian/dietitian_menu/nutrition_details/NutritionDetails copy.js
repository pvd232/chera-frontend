...
const NutritionDetails = (props) => {
  ...
  const handleClickOpen = async () => {
    setOpen(true);
    setLoading(true);
    const mealPlanMealDTO = await getMealPlanMeal(
      props.mealPlanId,
      props.mealId
    );
    setMealPlanMeal(mealPlanMealDTO);
    setLoading(false);
  };
          ...
          >
            <Grid container justifyContent={'space-evenly'}>
                  ...
                  >
                    <Grid item>
                      <NutritionLabel
                        ...
                        nutrients={getNutrientsDataSource(
                          mealPlanMeal.nutrients
                        )}
                      ></NutritionLabel>
                    </Grid>
                  </Grid>
              ...
              >
                ...
                <DailyNutrientChart
                  customTheme={customTheme}
                  dataSource={getNutrientsDataSource(mealPlanMeal.nutrients)}
                ></DailyNutrientChart>
              </Grid>
            </Grid>
          </DialogContent>
